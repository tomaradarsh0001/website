...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 06, 2024 at 02:39 PM
...
(20, 'Payment Help', 'भुगतान सहायता', 15, 'http://192.168.0.62:30/storage/pdf/eServices_PaymentFlow.pdf', 0, 'header', 5, 1, NULL, 2, '2024-05-01 05:49:29', '2024-05-17 04:29:18'),
...
(1, 'Admin', 'web', '2024-04-18 22:57:32', '2024-04-18 22:57:32'),
(2, 'Editor', 'web', '2024-05-02 04:49:26', '2024-05-02 04:49:26'),
(3, 'guest', 'web', '2024-05-02 04:56:04', '2024-05-02 04:56:04'),
(4, 'SuperAdmin', 'web', '2024-05-02 05:13:04', '2024-05-02 05:13:04');
...
--
-- Indexes for table `component_sections`
--
ALTER TABLE `component_sections`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `eso_courts`
--
ALTER TABLE `eso_courts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `eso_courts_section_id_foreign` (`section_id`);
...
--
-- AUTO_INCREMENT for table `component_sections`
--
ALTER TABLE `component_sections`
...
--
-- AUTO_INCREMENT for table `eso_courts`
--
ALTER TABLE `eso_courts`
...
--
-- AUTO_INCREMENT for table `office_docs`
--
ALTER TABLE `office_docs`
...
--
-- Constraints for table `eso_courts`
--
ALTER TABLE `eso_courts`
  ADD CONSTRAINT `eso_courts_section_id_foreign` FOREIGN KEY (`section_id`) REFERENCES `sections` (`id`);
