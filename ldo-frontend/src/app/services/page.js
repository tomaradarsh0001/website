        ...
        <div className="services-offered-page">
            ...
            <Modal isOpen={isModalOpen} onClose={closeModal}>
                ...
                <div className="more-info-link p-2 mt-4 ml-5">
                    {/* <Link className='read-docs-btn text-sm md:text-lg px-5 py-2 mr-2' href={"#"}>Read Docs </Link>
            <Link className='apply-btn text-sm md:text-lg px-5 py-2' href={"https://ldo.gov.in/edharti/"} target='_blank'>For Apply</Link> */}
                    <Link
